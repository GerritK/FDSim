...
public class TSFW extends Vehicle {
	...
	public TSFW(String name, int x, int y, Playground playground) {
		...
		bluelight[0] = new Bluelight(8, 21, Images.LIGHT_BLUE_1, 10, 90, 5, this);
		bluelight[0].setEnabled(true);
		
		bluelight[1] = new Bluelight(8, 21, Images.LIGHT_BLUE_1, 10, 90, 18, this);
		bluelight[1].setEnabled(true);
		
		bluelight[2] = new Bluelight(33, 21, Images.LIGHT_BLUE_1, 8, 85, 2, this);
		bluelight[2].setEnabled(true);
		
		bluelight[3] = new Bluelight(33, 21, Images.LIGHT_BLUE_1, 8, 85, 13, this);
