...
public class MTF extends Vehicle {
	...
	public MTF(String name, int x, int y,Playground playground) {
		...
		bluelight[0] = new Bluelight(6, 21, SimImage.LIGHT_BLUE_1, 10, 50, 3, this);
		bluelight[0].setEnabled(true);
		
		bluelight[1] = new Bluelight(31, 21, SimImage.LIGHT_BLUE_1, 8, 51, 1, this);
		bluelight[1].setEnabled(true);
		
		bluelight[2] = new Bluelight(8, 56, SimImage.LIGHT_BLUE_1, 9, 34, 2, this);
