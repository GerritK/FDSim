...
import net.gerritk.fdsim.gui.Bar;
import net.gerritk.fdsim.gui.TextButton;
...
public class BottomBar extends Bar {
	...
	public BottomBar(int x, int height) {
		...
		btnPause = new TextButton("P", 125, 1, 14, 14, this) {
	...
	public void draw(Graphics2D g) {		
		...
		g.drawString(m, (int) getWidth() - 120, (int) getHeight() - 2);
